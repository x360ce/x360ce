...
namespace x360ce.App
{
	...
	{
		// Content control.
		public ImageInfo(int image, MapCode code, double x, double y, object controlName, object controlXI, object controlBindedName, GamepadButtonFlags button = GamepadButtonFlags.None)
		{
			Image = image;
			Code = code;
			X = x;
		...
		public object ControlXI { get; set; }
