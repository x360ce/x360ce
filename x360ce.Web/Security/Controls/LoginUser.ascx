	...
	<div class="SWUI_Panel_Body">
		<div style="width: 100%;">
			<asp:Login ID="Login1" runat="server" OnLoggedIn="Login1_LoggedIn"
				OnLoginError="Login1_LoginError" Width="100%">
				<LayoutTemplate>
					<table border="0" class="SWUI_Table">
						<tr>
							...
							<td class="SWUI_Table_Value SWUI_100w">
								<asp:TextBox ID="UserName" runat="server" CssClass="SWUI_100w" />
							</td>
						...
						<tr>
							...
							<td class="SWUI_Table_Value">
								<asp:TextBox ID="Password" runat="server" TextMode="Password" CssClass="SWUI_100w" />
							</td>
							<td class="SWUI_Table_Check">
						...
						<tr>
							<td class="SWUI_Table_Label">Remember:
							</td>
							<td>
								<table border="0" style="width: 100%;" cellpaddin="0" cellspacing="0">
									<tr>
										<td style="padding-top: 3px;" class="SWUI_Table_Value">
											<asp:CheckBox ID="RememberMeCheckBox" runat="server" CssClass="SWUI_CheckBox" />
										</td>
										<td>
											<asp:LinkButton ID="LoginButton" runat="server" CommandName="Login" CssClass="SWUI_Table_Button SWUI_Btn"
