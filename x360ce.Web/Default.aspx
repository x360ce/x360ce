                        ...
                        <table style="width: 804px; margin-top: 4px;">
                            <tr>
                                <td class="Description" colspan="2" style="background-color: #ffbf00; padding: 10px; color: #111111; text-align: justify; border-radius: 14px; width: 804px;">
                                    ...
                                    • <a target="_blank" class="Blue" href="http://www.microsoft.com/en-us/download/details.aspx?id=21">.NET 3.5 (includes 2.0 and 3.0)</a> - included in Windows 7.<br /><span style="margin-left: 14px; font-size: 9pt;"><i>In Windows 8 and 10: <a  class="Blue" target="_blank" href="http://msdn.microsoft.com/en-us/library/hh506443.aspx">Control Panel &gt; Programs and Features &gt; Turn Windows features on or off > enable “.NET Framework 3.5 (includes 2.0 and 3.0)”</a>.</i></span><br />
                                    • <a target="_blank" class="Blue" href="http://www.microsoft.com/en-us/download/details.aspx?id=30653">.NET 4.5 (includes 4.0)</a> - included in Windows 8 and 10.<br />
                                    • <a target="_blank" class="Blue" href="http://www.microsoft.com/en-us/download/details.aspx?id=35">DirectX End-User Runtime (June 2010)</a> - Required regardless of OS; <span style="font-size: 9pt;"><i>.NET MUST be installed prior to the DirectX update.</i></span><br />
