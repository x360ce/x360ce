                                ...
                                <td colspan="2" style="background-color: #2674ec; padding: 10px; text-align: center; border-radius: 14px;">
                                    ...
                                    <table style="border-collapse: separate; border-spacing: 4px;">
                                        <tr>
                                            ...
                                            <td style="vertical-align: bottom;"><a class="GitHub" href="Files/x360ce.zip">Download x360ce 3.0.2.25 (2015-04-30) 32-bit</a></td>
					                    </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td style="vertical-align: bottom;"><a class="GitHub" href="Files/x360ce_x64.zip">Download x360ce 3.0.2.25 (2015-04-30) 64-bit</a></td>
					                    </tr>
                                    </table>
