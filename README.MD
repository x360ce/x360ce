...
IMPORTANT: Please download and run digitally signed files only! If someone asks to disable antivirus or exclude X360CE app from anti-virus check - DON'T! Report any suspicion as [Issue](https://github.com/x360ce/x360ce/issues) and we will try to resolve any false positive with anti-virus developers.
