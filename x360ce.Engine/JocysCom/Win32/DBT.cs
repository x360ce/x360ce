...
namespace JocysCom.ClassLibrary.Win32
{
	public enum DBT
	{
		/// <summary>A request to change the current configuration (dock or undock) has been cancelled.</summary>
		...
		/// <summary>A request to remove a device or piece of media has been cancelled.</summary>
