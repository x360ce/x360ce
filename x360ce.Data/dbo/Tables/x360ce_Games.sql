CREATE TABLE [dbo].[x360ce_Games] (
    ...
    [DiskDriveId]           UNIQUEIDENTIFIER CONSTRAINT [DF_x360ce_Games_DiskDriveId] DEFAULT ('00000000-0000-0000-0000-000000000000') NOT NULL,
    ...
    [FileVersion]           NVARCHAR (32)    CONSTRAINT [DF_x360ce_Games_FileVersion] DEFAULT ('') NOT NULL,
    ...
    [XInputMask]            INT              CONSTRAINT [DF_x360ce_Games_XInputFileName] DEFAULT ((0)) NOT NULL,
    ...
    [FakeVID]               INT              CONSTRAINT [DF_x360ce_Games_FakeVID] DEFAULT ((0)) NOT NULL,
