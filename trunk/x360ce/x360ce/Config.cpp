...
void ReadPadConfig(DWORD idx) {
	...
	g_Gamepad[idx].passthrough = (BOOL) (ReadLongFromFile(section, L"PassThrough",1));
	...
	g_Gamepad[idx].axistodpad = static_cast<BOOL>(ReadLongFromFile(section, L"AxisToDPad",0));
