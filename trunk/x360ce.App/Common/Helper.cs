...
namespace x360ce.App
{
	public class Helper
	{
		...
		public static com.x360ce.localhost.Program[] GetLocalFiles(string path = ".")
		{
			...
			foreach (var name in names)
			{
				...
				var program = new com.x360ce.localhost.Program();
		...
		public static void SerializeToXmlFile(object o, string filename, Encoding encoding)
		{
			...
			lock (serializer)
			{
				...
				catch (Exception) { xw.Close(); fs.Close(); throw; }
			}
			xw.Flush();
			xw.Close();
			fs.Close();
