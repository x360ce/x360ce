...
namespace x360ce.App.XnaInput
{
	public static class UnsafeNativeMethods
	{
        ...
        {
            IntPtr procAddress = Win32.NativeMethods.GetProcAddress(libHandle, "XInputGetCapabilities");
        ...
        internal static ErrorCodes SetState(PlayerIndex playerIndex, out XINPUT_VIBRATION pVibration)
		{
