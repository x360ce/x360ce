CREATE TABLE [dbo].[x360ce_PadSettings] (
    ...
    [ButtonA]                  VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonA] DEFAULT ('') NOT NULL,
    [ButtonB]                  VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonB] DEFAULT ('') NOT NULL,
    [ButtonBig]                VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonBig] DEFAULT ('') NOT NULL,
    [ButtonBack]               VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonBack] DEFAULT ('') NOT NULL,
    [ButtonGuide]              VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonGuide] DEFAULT ('') NOT NULL,
    [ButtonStart]              VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonStart] DEFAULT ('') NOT NULL,
    [ButtonX]                  VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonX] DEFAULT ('') NOT NULL,
    [ButtonY]                  VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_ButtonY] DEFAULT ('') NOT NULL,
    [DPad]                     VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_DPad] DEFAULT ('') NOT NULL,
    [DPadDown]                 VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_DPadDown] DEFAULT ('') NOT NULL,
    [DPadLeft]                 VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_DPadLeft] DEFAULT ('') NOT NULL,
    [DPadRight]                VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_DPadRight] DEFAULT ('') NOT NULL,
    [DPadUp]                   VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_DPadUp] DEFAULT ('') NOT NULL,
    ...
    [ForceSpringEnable]        VARCHAR (16)     CONSTRAINT [DF_x360ce_PadSettings_ForceSpringEnable] DEFAULT ('') NOT NULL,
    [ForceSpringStrength]      VARCHAR (16)     CONSTRAINT [DF_x360ce_PadSettings_ForceSpringStrength] DEFAULT ('') NOT NULL,
    [WheelRange]               VARCHAR (16)     CONSTRAINT [DF_x360ce_PadSettings_WheelRange] DEFAULT ('') NOT NULL,
    ...
    [LeftShoulder]             VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftShoulder] DEFAULT ('') NOT NULL,
    [LeftThumbAxisX]           VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftThumbAxisX] DEFAULT ('') NOT NULL,
    ...
    [LeftThumbAxisY]           VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftThumbAxisY] DEFAULT ('') NOT NULL,
    ...
    [LeftThumbButton]          VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftThumbButton] DEFAULT ('') NOT NULL,
    [LeftThumbDown]            VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftThumbDown] DEFAULT ('') NOT NULL,
    [LeftThumbLeft]            VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftThumbLeft] DEFAULT ('') NOT NULL,
    [LeftThumbRight]           VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftThumbRight] DEFAULT ('') NOT NULL,
    [LeftThumbUp]              VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftThumbUp] DEFAULT ('') NOT NULL,
    [LeftTrigger]              VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_LeftTrigger] DEFAULT ('') NOT NULL,
    ...
    [RightShoulder]            VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightShoulder] DEFAULT ('') NOT NULL,
    [RightThumbAxisX]          VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightThumbAxisX] DEFAULT ('') NOT NULL,
    ...
    [RightThumbAxisY]          VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightThumbAxisY] DEFAULT ('') NOT NULL,
    ...
    [RightThumbButton]         VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightThumbButton] DEFAULT ('') NOT NULL,
    [RightThumbDown]           VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightThumbDown] DEFAULT ('') NOT NULL,
    [RightThumbLeft]           VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightThumbLeft] DEFAULT ('') NOT NULL,
    [RightThumbRight]          VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightThumbRight] DEFAULT ('') NOT NULL,
    [RightThumbUp]             VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightThumbUp] DEFAULT ('') NOT NULL,
    [RightTrigger]             VARCHAR (128)     CONSTRAINT [DF_x360ce_PadSettings_RightTrigger] DEFAULT ('') NOT NULL,
